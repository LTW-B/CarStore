        ...
        <div class="container ">
            <div class="col-12 mb-2">
                <div class="d-flex row-cols align-items-canter">
                    ...
                    <form action="<?php echo e(route('filterCarparts')); ?>" method="POST" id="myForm">
                        <?php echo csrf_field(); ?>
                        <select name="selectedCategory" id="selectedCategory" class="form-select ms-3">
                            ...
                            <?php $__currentLoopData = $linhkienData['stores']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col mx-5">
                        <a href="/linhkien" class="btn btn-outline-light">Hủy lọc</a>
                    </div>
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-sm-2 row-cols-lg-4 gap-3">
                <?php if(isset( $linhkienData['selectedResults'])): ?>
                    <?php $__currentLoopData = $linhkienData['selectedResults']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 col-lg-4 col-sm-12 mb-2 d-flex row">
                            <div class="card">
                                <div class="image-container" style="height: 350px; overflow: hidden; margin-top: 10px;">
                                    ...
                                    <a href="<?php echo e(route('carpart.show', ['id' => $store->id])); ?>">
                                        <img src="<?php echo e(route('carpart.showImage', ['filename' => $store['image']])); ?>"
                                            alt="image" class="card-img-top img-card">
                                    </a>
                                </div>
                                <div class="position-absolute mt-2">
                                    <i class="fa-regular fa-bookmark fa-2x " style="color: #d03809"></i> <span class="fs-3"style="color: #d03809"><?php echo e($store->condition); ?></span>
                                </div>
