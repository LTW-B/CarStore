        ...
        <div class="row g-5">
            <div class="col-lg-6 pt-4" style="min-height: 400px;">
                <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                    <img class="position-absolute img-fluid w-100 h-100" src="<?php echo e(asset('img/about.jpg')); ?>" style="object-fit: cover;"
                        alt="">
        ...
        <section class="section bg-light mt-5">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo e(asset('./img/founder.jpg')); ?>" alt="LexuZ History" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\D\resources\views/home/about.blade.php ENDPATH**/ ?>