...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('plugins/font-awesome/css/all.min.css')); ?>">
    ...
    <title>
        <?php echo $__env->yieldContent('title', 'Official LexuZ Website'); ?>
    </title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container text-black-50">
            <a href="<?php echo e(route('home')); ?>" class="" data-event-module-slug="header"data-event-label="logo">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto text-uppercase ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('home')); ?>">LexuZ</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="StoreDropdown">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('store.index')); ?>">
                                    <i class="fa-solid fa-car me-2"></i>Xe oto
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item " href="<?php echo e(route('home.linhkien')); ?>">
                    ...
                    <?php if(auth()->check() &&
                            auth()->user()->isAdmin()): ?>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="<?php echo e(route('admin.home.index')); ?>">Admin <i class="fa-solid fa-screwdriver-wrench"></i></a>
                        </li>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('home.service')); ?>">
                                    <i class="fa-brands fa-servicestack  me-2"></i>Dịch vụ
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('home.team')); ?>">
                                    <i class="fa-solid fa-users  me-2"></i>Đội ngũ
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('home.testimonial')); ?>">
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    $('#SearchInput').on('keyup input', function() {
                                        ...
                                        if (input != null) {
                                            $.ajax({
                                                url: '<?php echo e(route('suggest_ajax')); ?>', // Đường dẫn đã đăng ký trong route
                                                method: 'get',
                                                data: {
                                                    SearchInput: input
                                    ...
                                    $('#searchResult').on('click', 'li', function() {
                                        ...
                                        var redirectUrl = '<?php echo e(route('search')); ?>?SearchValue=' + encodeURIComponent(selectedText);
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <ul class="dropdown-menu" aria-labelledby="UserDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('register')); ?>"><i
...
<?php /**PATH D:\D\resources\views/layouts/app.blade.php ENDPATH**/ ?>