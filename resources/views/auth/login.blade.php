        ...
        <form class="form_container" action="{{ route('login') }}" method="POST">
            ...
            <br>
                ...
                <div class="input_container">
                    <label class="input_label" for="email">{{ __('Email Address') }}</label>
                    ...
                    <input placeholder="name@mail.com" title="Input title" id="email" type="email"
                        class="form-control @error('email') is-invalid @enderror input_field" name="email"
                        value="{{ old('email') }}" required autocomplete="email" autofocus>
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="input_container">
                    <label class="input_label" for="password">{{ __('Password') }}</label>
                    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg"
                        class="icon">
                    ...
                    <input placeholder="Password" title="Inpit title" id="password" type="password"
                        class="form-control @error('password') is-invalid @enderror input_field" name="password" required
