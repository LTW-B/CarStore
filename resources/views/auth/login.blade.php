        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form action="{{ route('login') }}" method="POST">
            ...
            <div class="form-outline mb-4">
                ...
                class="form-control form-control-lg @error('email') is-invalid @enderror input_field" name="email"
                value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            <div class="form-outline mb-3">
                <input placeholder="Password" title="Inpit title" id="password" type="password"
                        class="form-control form-control-lg @error('password') is-invalid @enderror input_field" name="password" required
