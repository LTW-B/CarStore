...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item dropdown" role="presentation">
        <button class="nav-link dropdown-toggle" id="dropdownTab" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Dropdown
        </button>
        <ul class="dropdown-menu" aria-labelledby="dropdownTab">
            <li><a class="dropdown-item" href="#child1" data-bs-toggle="tab" role="tab" aria-controls="child1">Child 1</a></li>
            <li><a class="dropdown-item" href="#child2" data-bs-toggle="tab" role="tab" aria-controls="child2">Child 2</a></li>
        </ul>
    </li>
</ul>
